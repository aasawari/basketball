...
public class SimulationView extends View implements SensorEventListener {
    ...
    private static final int BALL_SIZE = 192;
    private static final int HOLE_SIZE = 240;
    ...
    public SimulationView(Context context) {
        ...
        opts.outWidth = getWidth();
        opts.outHeight = getHeight();
        mGrass = BitmapFactory.decodeResource(getResources(), R.drawable.field, opts);
...
//            Thread.sleep(5);
//        }catch (Exception ex){
//            Log.e("Simulation view: ","thread error");
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.i("******",mSensorX+" "+ mSensorY+" "+getWidth()/2+" "+getHeight()/2);
        if(mSensorX == getWidth()/2 && mSensorY == getHeight()/2){
            Log.i("*****goal: ","*****");
        }
